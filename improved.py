...
while True:
    ...
    while not gameexit:
        ...
        for event in pygame.event.get():
            ...
            if event.type==pygame.KEYDOWN:
                ...
                if event.key==pygame.K_LEFT:
                    ...
                    x_coordinate=0
                    y_coordinate=block_size  
        if((ball_x>=785 or ball_x<10 or ball_y>=585 or ball_y<10 )and count<200):
            gameexit=True
            time.sleep(1)
            y=time.time()
        if((ball_x>=785 or ball_x<10 or ball_y>=585 or ball_y<10 or ((ball_x in range(x1,x1+80))and (ball_y in range(y1,y1+50))))and count in range(250,650)):
            gameexit=True
            time.sleep(1)
            y=time.time()
        if((ball_x>=785 or ball_x<10 or ball_y>=585 or ball_y<10 or ((ball_x in range(x1,x1+80))and (ball_y in range(y1,y1+50))) or ((ball_x in range(x2,x2+80))and(ball_y in range(y2,y2+50))))and count in range(600,1000)):
            gameexit=True
            time.sleep(1)
            y=time.time()
        if((ball_x>=785 or ball_x<10 or ball_y>=585 or ball_y<10 or ((ball_x in range(x1,x1+80))and (ball_y in range(y1,y1+50)))or((ball_x in range(x2,x2+80))and(ball_y in range(y2,y2+50)))or ((ball_x in range(x3,x3+80)) and (ball_y in range(y3,y3+50))))and count in range(1000,1400)):
            gameexit=True
            time.sleep(1)
            y=time.time()
        if((ball_x>=785 or ball_x<10 or ball_y>=585 or ball_y<10 or ((ball_x in range(x1,x1+80))and (ball_y in range(y1,y1+50)))or((ball_x in range(x2,x2+80))and(ball_y in range(y2,y2+50)))or ((ball_x in range(x3,x3+80)) and (ball_y in range(y3,y3+50)))or  ((ball_x in range(x4,x4+80))and(ball_y in range(y4,y4+50))))and count>1400):
            gameexit=True
            time.sleep(1)
            y=time.time()
        ...
        if(count in range(200,600)):
            gameDisplay.blit(water,[x1,y1])
        if(count in range(600,1000)):
            gameDisplay.blit(water,[x1,y1])
            gameDisplay.blit(water,[x2,y2])
        if(count in range(1000,1400)):
            gameDisplay.blit(water,[x1,y1])
            gameDisplay.blit(water,[x2,y2])
